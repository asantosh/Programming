...
def updateHand(hand, word):
    ...
    for ch in word:
        if ch in handCopy:
            if handCopy.get(ch, 0) > 0:
                handCopy[ch] = handCopy.get(ch, 0) - 1
    return handCopy
...
def playGame(wordList):
    ...
    n = 7
    handPrev = {}
    usrIn = raw_input('Enter n to deal a new hand, r to replay the last hand, or e to end game: ')
